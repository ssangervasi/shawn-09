...
const TEST_NONPEDANTIC_INPUT_OUTPUT : Array<TestConfig> = [
	...
	{ phrase: 'Sean', expected: 'Shawn'},
	{ phrase: 'sean', expected: 'shean'},
	{ phrase: 'I see Sean', expected: 'I shee Shawn'},
	{ phrase: 'I see Sean.', expected: 'I shee Shean.'},
	{ phrase: 'I see sean', expected: 'I shee shean'},
	{ phrase: 'I see sean.', expected: 'I shee shean.'},
	...
	{ phrase: 'Sean schwimmt auf einem Floß.', expected: 'Shawn shchwimmt auf einem Floß.'},
	{ phrase: 'My favorite vowel sound is the schwa.', expected: 'My favorite vowel shound ish the shchwa.'},
]
